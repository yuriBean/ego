...
export default function Login() {
    ...
    const handleSubmit = async () => {
      ...
      try {
        axios
          .get(
            `${process.env.REACT_APP_BACKEND_PORT}/auth?email=${userData.email}&password=${userData.password}`,
            {
              headers: {
            ...
            if (!res.data.payment && !res.data.isTrial) {
              ...
              if (!paymentType) {
                ...
                if (paymentType.toLowerCase() === "monthly") {
                  await axios
                    .get(
                      `${process.env.REACT_APP_BACKEND_PORT}/checkout/monthly?userId=${res.data.userId}&amount=${amount}&landingPages=${landingPages}`
                    )
                    .then((res) => {
                  ...
                  await axios
                    .get(
                      `${process.env.REACT_APP_BACKEND_PORT}/checkout/yearly?userId=${res.data.userId}&amount=${amount}&landingPages=${landingPages}`
                    )
                    .then((res) => {
                      window.open(res.data.session.url);
                    });
      ...
      <div className="flex items-center justify-center h-full mt-10">
        <div className="flex flex-col bg-white rounded-3xl shadow-xl max-w-[400px] w-full">
          <div className="flex flex-col w-full text-center bg-white">
            <div className="flex flex-col w-full px-6 pt-6 bg-white">
          ...
          <div className="flex flex-col justify-center w-full px-6">
            ...
            <div className="flex items-center justify-between gap-0 pr-2 mt-5 text-sm leading-5">
              ...
              <div
                ...
                className="justify-end font-semibold text-indigo-400 cursor-pointer"
              >
                Mot de passe oublié ?
              </div>
            </div>
            <div className="flex items-center justify-between gap-0 pr-2 mt-6 text-sm leading-5 text-gray-600">
              <p>
          ...
          <div className="flex flex-col w-full pt-8 text-base font-semibold leading-6 whitespace-nowrap">
            <div className="flex flex-col w-full px-6 pb-6 bg-white">
              <button
              ...
              <div
                ...
                className="justify-center text-center items-center px-5 py-2.5 mt-3 text-black bg-white rounded-lg cursor-pointer border border-gray-300 border-solid shadow-sm"
              >
                Annuler
              </div>
            </div>
